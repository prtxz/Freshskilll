              ...
              {slide.isIntro ? (
                ...
                <div className="relative w-full h-full flex items-center justify-center bg-black overflow-hidden font-mono">
                  ...
                  >
                    ...
                    >
                      <h2 className="text-[12vw] font-black leading-[0.8] tracking-tighter text-white uppercase whitespace-nowrap">
                        EXPLORE
                      </h2>
                      <h2 className="text-[10vw] font-black leading-[0.8] tracking-tighter text-white/50 uppercase whitespace-nowrap">
                        OUR
                      </h2>
                      <h2 className="text-[14vw] font-black leading-[0.8] tracking-tighter text-[#ff6b35] uppercase whitespace-nowrap">
                        ECOSYSTEM
                      </h2>
                    </motion.div>
                  </div>
